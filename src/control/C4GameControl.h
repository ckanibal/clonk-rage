...
class C4GameControl {
 ...
 protected:
  ...
  C4Control *pExecutingControl;  // Control that is in the process of being
                                 // executed - needed by non-initial records
 ...
 public:
  ...
  void DbgRec(C4RecordChunkType eType, const uint8_t *pData = NULL,
              size_t iSize = 0);  // record debug stuff

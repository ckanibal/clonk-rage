...
class C4DownloadDlg : public C4GUI::Dialog {
 ...
 private:
  // updates the displayed status text and progress bar - repositions elements
  // if necessary
 ...
 protected:
  ...
  // downloads the specified file to the specified location. Returns whether
  // successful
  bool ShowModal(C4GUI::Screen *pScreen, const char *szURL,
 ...
 public:
  ...
  static bool DownloadFile(const char *szDLType, C4GUI::Screen *pScreen,
                           const char *szURL, const char *szSaveAsFilename,
                           const char *szNotFoundMessage = NULL);
};

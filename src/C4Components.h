...
#define C4CFN_WriteTitle \
  "Title.txt"  // file that is generated if a title is set automatically
...
#define C4CFN_ClonkRank \
  "Rank.png"  // custom rank in info file: One rank image only
...
#define C4FLS_Scenario                                                         \
  "Loader*.bmp|Loader*.png|Loader*.jpeg|Loader*.jpg|Fonts.txt|Scenario.txt|"   \
  "Title*.txt|Info.txt|Desc*.rtf|Icon.png|Icon.bmp|Game.txt|StringTbl*.txt|"   \
  "Teams.txt|Parameters.txt|Info.txt|Sect*.c4g|Music.c4g|*.mid|*.wav|Desc*."   \
  "rtf|Title.bmp|Title.png|*.c4d|Material.c4g|MatMap.txt|Landscape.bmp|"       \
  "Landscape.png|" C4CFN_DiffLandscape                                         \
  "|Sky.bmp|Sky.png|Sky.jpeg|Sky.jpg|PXS.c4b|MassMover.c4b|CtrlRec.c4b|"       \
  "Strings.txt|Objects.txt|RoundResults.txt|Author.txt|Version.txt|Names.txt|" \
  "*.c4d|Script.c|Script*.c|System.c4g"
#define C4FLS_Section                                                      \
  "Scenario.txt|Game.txt|Landscape.bmp|Landscape.png|Sky.bmp|Sky.png|Sky." \
  "jpeg|Sky.jpg|PXS.c4b|MassMover.c4b|CtrlRec.c4b|Strings.txt|Objects.txt"
#define C4FLS_SectionLandscape \
  "Scenario.txt|Landscape.bmp|Landscape.png|PXS.c4b|MassMover.c4b"
#define C4FLS_SectionObjects "Strings.txt|Objects.txt"
#define C4FLS_Def                                                              \
  "Particle.txt|DefCore.txt|Graphics.bmp|Graphics.png|Overlay.png|Graphics*."  \
  "png|Overlay*.png|Portrait*.png|Portrait*.bmp|ActMap.txt|Script.c|Script*."  \
  "c|C4Script.c|StringTbl*.txt|Names*.txt|Title*.txt|ClonkNames.txt|Rank.txt|" \
  "Rank.bmp|Rank.png|Desc*.txt|Overlay.png|Title.bmp|Title.png|Icon.bmp|"      \
  "Author.txt|Version.txt|*.wav|*.c4d"
#define C4FLS_Player "Player.txt|Portrait.png|Portrait.bmp|*.c4i"
#define C4FLS_Object "ObjectInfo.txt|Portrait.png|Portrait.bmp"
#define C4FLS_Folder                                                       \
  "Folder.txt|Title*.txt|Info.txt|Desc*.rtf|Title.png|Title.bmp|Icon.png|" \
  "Icon.bmp|Author.txt|Version.txt|*.c4s|Loader*.bmp|Loader*.png|Loader*." \
  "jpeg|Loader*.jpg|FolderMap.txt|FolderMap.png"
#define C4FLS_Material "TexMap.txt|*.bmp|*.png|*.c4m"
#define C4FLS_Graphics                                                         \
  "Loader*.bmp|Loader*.png|Loader*.jpeg|Loader*.jpg|FontEndeavour12.png|"      \
  "FontEndeavour24.png|FontEndeavour16.png|FontEndeavour10.png|Font*.png"      \
  "|*.pal|Control.png|Fire.png|Background.png|Flag.png|Crew.png|Score.png|"    \
  "Wealth.png|Player.png|Rank.png|Entry.png|Captain.png|Cursor.png|"           \
  "CursorSmall.png|CursorMedium.png|CursorLarge.png|SelectMark.png|"           \
  "MenuSymbol.png|Menu.png|Logo.png|Construction.png|Energy.png|Magic.png|"    \
  "Options.png|UpperBoard.png|Arrow.png|Exit.png|Hand.png|Gamepad.png|Build."  \
  "png|EnergyBars.png|Liquid.png"                                              \
  "|GUICaption.png|GUIButton.png|GUIButtonDown.png|GUIButtonHighlight.png|"    \
  "GUIIcons.png|GUIIcons2.png|GUIScroll.png|GUIContext.png|GUISubmenu.png|"    \
  "GUICheckBox.png|GUIBigArrows.png|GUIProgress.png"                           \
  "|StartupScenSelBG.*|StartupPlrSelBG.*|StartupPlrPropBG.*|StartupNetworkBG." \
  "*|StartupAboutBG.*|StartupBigButton.png|StartupBigButtonDown.png|"          \
  "StartupBookScroll.png|StartupContext.png|StartupScenSelIcons.png|"          \
  "StartupScenSelTitleOv.png|StartupPlrCtrlType.png|StartupDlgPaper.png|"      \
  "StartupOptionIcons.png|StartupTabClip.png|StartupNetGetRef.png"
#define C4FLS_Objects "Names*.txt|Desc*.txt|*.c4d"
#define C4FLS_Mouse                                                         \
  "*.txt|*.rtf|Title.bmp|Title.png|Icon.bmp|Tutorial01.c4s|Tutorial02.c4s|" \
  "Tutorial03.c4s|Objects.c4d"
#define C4FLS_Keyboard                                                      \
  "*.txt|*.rtf|Title.bmp|Title.png|Icon.bmp|Tutorial01.c4s|Tutorial02.c4s|" \
  "Tutorial03.c4s|Tutorial04.c4s|Tutorial05.c4s|Tutorial06.c4s|Tutorial07." \
  "c4s|Tutorial08.c4s|Tutorial09.c4s|Tutorial10.c4s"
#define C4FLS_Easy                                                         \
  "*.txt|*.rtf|Title.bmp|Title.png|Icon.bmp|Goldmine.c4s|Monsterkill.c4s|" \
  "Economy.c4s|Melee.c4s|Lake.c4s|Castle.c4s"
#define C4FLS_System                                                         \
  "*.hlp|*.cnt|Language*.txt|*.fon|*.fnt|*.ttf|*.ttc|*.fot|*.otf|Fonts.txt|" \
  "Alchem.c|StringTbl*.txt|*.c|Names.txt"
#define C4FLS_Music "Frontend.*|Credits.*"
// western foldermap hardcoded...
#define C4FLS_Western                                                          \
  C4FLS_Folder                                                                 \
      "|ScenGCBase.png|ScenGC.png|ScenDMVBase.png|ScenDMV.png|ScenFSBase.png|" \
      "ScenFS.png|ScenCTFBase.png|ScenCTF.png|ScenLHBase.png|ScenLH.png|"      \
      "ScenMCBase.png|ScenMC.png|ScenMWBase.png|ScenMW.png|ScenBRBase.png|"    \
      "ScenBR.png|ScenTHBase.png|ScenTH.png|ScenGRBase.png|ScenGR.png|"        \
      "ScenSTSBase.png|ScenSTS.png|ScenNWBase.png|ScenNW.png|AccLH.png|AccFS." \
      "png|AccGC.png|AccGR.png|AccMW.png|AccNW.png"

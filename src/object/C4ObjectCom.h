...
void DrawCommandKey(C4Facet &cgo, int32_t iCom, BOOL fPressed = FALSE,
                    const char *szText = NULL);

void DrawControlKey(C4Facet &cgo, int32_t iControl, BOOL fPressed = FALSE,
                    const char *szText = NULL);
...
BOOL PlayerObjectCommand(int32_t plr, int32_t cmdf, C4Object *pTarget = NULL,

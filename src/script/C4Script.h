...
struct C4ScriptFnDef {
  ...
  C4V_Type
      ParType[10];  // type of the parameters. error when wrong parameter type.
  C4Value (*FunctionC4V)(C4AulContext *cthr, C4Value *, C4Value *, C4Value *,
...
#define PSF_InitializePlayer \
  "~InitializePlayer"  // iPlayer, iX, iY, pBase, iTeam, idExtra
...
#define PSF_ControlCommandFinished \
  "~ControlCommandFinished"  // szCommand, pTarget, iTx, iTy, pTarget2, iData
...
#define PSF_RejectContents \
  "~RejectContents"  // blocks opening of activate/get/contents menus; no
                     // parameters
...
#define PSF_MenuSelection \
  "~OnMenuSelection"  // int iItemIndex, C4Object *pMenuObject
...
#define PSF_FxStart \
  "Fx%sStart"  // C4Object *pTarget, int iEffectNumber, int iTemp, C4Value
               // vVar1, C4Value vVar2, C4Value vVar3, C4Value vVar4
#define PSF_FxStop \
  "Fx%sStop"  // C4Object *pTarget, int iEffectNumber, int iReason, BOOL fTemp
#define PSF_FxTimer \
  "Fx%sTimer"  // C4Object *pTarget, int iEffectNumber, int iEffectTime
#define PSF_FxEffect \
  "Fx%sEffect"  // C4String *szNewEffect, C4Object *pTarget, int iEffectNumber,
                // int iNewEffectNumber, C4Value vNewEffectVar1, C4Value
                // vNewEffectVar2, C4Value vNewEffectVar3, C4Value
                // vNewEffectVar4
#define PSF_FxDamage \
  "Fx%sDamage"  // C4Object *pTarget, int iEffectNumber, int iDamage, int
                // iCause, int iCausePlayer
#define PSF_FxCustom \
  "Fx%s%s"  // C4Object *pTarget, int iEffectNumber, C4Value vVar1, C4Value
            // vVar2, C4Value vVar3, C4Value vVar4, C4Value vVar5, C4Value
            // vVar6, C4Value vVar7
#define PSF_FireMode "~FireMode"
#define PSF_FrameDecoration "~FrameDecoration%s"
#define PSF_GetFairCrewPhysical \
  "~GetFairCrewPhysical"  // C4String *szPhysicalName, int iRank, int
                          // iPrevPhysical
#define PSF_DoMagicEnergy \
  "DoMagicEnergy"  // int iChange, C4Object *pObj, bool fAllowPartial
#define PSF_GetCustomComponents "~GetCustomComponents"  // C4Object *pBuilder
#define PSF_RejectHostilityChange \
  "~RejectHostilityChange"  // int iPlr1, int iPlr2, bool fNewHostility
#define PSF_RejectTeamSwitch "~RejectTeamSwitch"  // int iPlr, int idNewTeam
#define PSF_OnHostilityChange \
  "~OnHostilityChange"  // int iPlr1, int iPlr2, bool fNewHostility, bool
                        // fOldHostility
#define PSF_OnTeamSwitch \
  "~OnTeamSwitch"  // int iPlr1, int idNewTeam, int idOldTeam
#define PSF_OnOwnerRemoved "~OnOwnerRemoved"

// Fx%s is automatically prefixed
#define PSFS_FxAdd \
  "Add"  // C4Object *pTarget, int iEffectNumber, C4String *szNewEffect, int
         // iNewTimer, C4Value vNewEffectVar1, C4Value vNewEffectVar2, C4Value
         // vNewEffectVar3, C4Value vNewEffectVar4
#define PSFS_FxInfo "Info"  // C4Object *pTarget, int iEffectNumber

// Construction is used instead of Construct intentionally, because this
// callback
...
#define PSF_ControlCommandAcquire \
  "~ControlCommandAcquire"  // C4Object *pTarget (unused), int iRangeX, int
                            // iRangeY, C4Object *pExcludeContainer, C4ID
                            // idAcquireDef
#define PSF_ControlCommandConstruction \
  "~ControlCommandConstruction"  // C4Object *pTarget (unused), int iRangeX, int
                                 // iRangeY, C4Object *pTarget2 (unused), C4ID
                                 // idConstructDef

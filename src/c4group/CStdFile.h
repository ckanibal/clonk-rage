...
class CStdFile : public CStdStream {
 ...
 public:
  ...
  bool Load(const char *szFileName, BYTE **lpbpBuf, int *ipSize = NULL,
            int iAppendZeros = 0, bool fCompressed = false);
  bool Save(const char *szFileName, const BYTE *bpBuf, int iSize,

 ...
 */
// an associated list
// used by C4AulScriptEngine, as virtual function table and include/dependency
// list
...
class C4AList {
 ...
 public:
  ...
  C4AListEntry *push(C4ID Var = C4ID_None,
                     void *pVal = NULL);  // push var/value pair to end of list
};

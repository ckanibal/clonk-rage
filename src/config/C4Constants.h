...
const int C4MaxNameList = 10,
    ...
    C4MaxDefString = 100, C4MaxTitle = 512, C4MaxMessage = 256,
          ...
          C4MaxColor = 12, C4MaxKey = 12, C4MaxKeyboardSet = 4,
          C4MaxControlSet = C4MaxKeyboardSet + 4,  // keyboard sets+gamepads

    C4MaxControlRate = 20,

          C4MaxGammaUserRamps = 8, C4MaxGammaRamps = C4MaxGammaUserRamps + 1;
...
const int C4SymbolSize = 35, C4SymbolBorder = 5, C4UpperBoardHeight = 50,
          C4PictureSize = 64, C4MaxPictureSize = 150, C4MaxBigIconSize = 64;
...
const int C4P_Control_None = -1, C4P_Control_Keyboard1 = 0,
          ...
          C4P_Control_GamePad2 = 5, C4P_Control_GamePad3 = 6,
          C4P_Control_GamePad4 = 7,
          C4P_Control_GamePadMax = C4P_Control_GamePad4;

const int C4ViewportScrollBorder =
    40;  // scrolling past landscape allowed at range of this border
...
const uint32_t OCF_None = 0, OCF_All = ~OCF_None, OCF_Normal = 1,
               OCF_Construct = 1 << 1, OCF_Grab = 1 << 2,
               OCF_Carryable = 1 << 3, OCF_OnFire = 1 << 4,
               OCF_HitSpeed1 = 1 << 5, OCF_FullCon = 1 << 6,
               ...
               OCF_InLiquid = 1 << 24, OCF_InSolid = 1 << 25,
               OCF_InFree = 1 << 26, OCF_Available = 1 << 27,
               OCF_PowerConsumer = 1 << 28, OCF_PowerSupply = 1 << 29,
               OCF_Container = 1 << 30, OCF_Alive = 1 << 31;
...
const BYTE  // Directional
    CNAT_None = 0,
    CNAT_Left = 1, CNAT_Right = 2, CNAT_Top = 4, CNAT_Bottom = 8,
    CNAT_Center = 16,
    // Additional flags
...
const BYTE CNAT_Flags =
    CNAT_MultiAttach | CNAT_NoCollision;  // all attchment flags that can be
                                          // combined with regular attachment
...
const BYTE COM_Left = 1, COM_Right = 2, COM_Up = 3, COM_Down = 4, COM_Throw = 5,
           ...
           COM_WheelUp = 10, COM_WheelDown = 11,

           COM_Left_R = COM_Left + 16, COM_Right_R = COM_Right + 16,
           COM_Up_R = COM_Up + 16, COM_Down_R = COM_Down + 16,
           COM_Throw_R = COM_Throw + 16, COM_Dig_R = COM_Dig + 16,
           COM_Special_R = COM_Special + 16, COM_Special2_R = COM_Special2 + 16,
           COM_ReleaseFirst = COM_Left_R, COM_ReleaseLast = COM_Special2_R,
...
const BYTE COM_Help = 35, COM_PlayerMenu = 36, COM_Chat = 37;

const BYTE COM_MenuEnter = 38, COM_MenuEnterAll = 39, COM_MenuClose = 40,
           COM_MenuShowText = 42, COM_MenuLeft = 52, COM_MenuRight = 53,
           COM_MenuUp = 54, COM_MenuDown = 55, COM_MenuSelect = 60,

           COM_MenuFirst = COM_MenuEnter, COM_MenuLast = COM_MenuSelect,
...
//=================================== SendCommand
//========================================
const int32_t C4P_Command_None = 0, C4P_Command_Set = 1, C4P_Command_Add = 2,
...
const int BASE_RegenerateEnergyPrice = 5, BASEFUNC_Default = 0xffff,
          BASEFUNC_AutoSellContents = 1 << 0,
          BASEFUNC_RegenerateEnergy = 1 << 1, BASEFUNC_Buy = 1 << 2,
          BASEFUNC_Sell = 1 << 3, BASEFUNC_RejectEntrance = 1 << 4,
          BASEFUNC_Extinguish = 1 << 5;

//=================================== League (escape those damn circular
//includes =========
...
//=================================== Player (included by C4PlayerInfo and
//C4Player)

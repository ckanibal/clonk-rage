...
class C4PathFinderRay {
 ...
 protected:
  ...
  void CrawlByAttach(int32_t &rX, int32_t &rY, int32_t iAttach,
                     int32_t iDirection);
  ...
  BOOL Execute();
  BOOL CrawlTargetFree(int32_t iX, int32_t iY, int32_t iAttach,
                       int32_t iDirection);
  BOOL PointFree(int32_t iX, int32_t iY);
  BOOL Crawl();
  BOOL PathFree(int32_t &rX, int32_t &rY, int32_t iToX, int32_t iToY,
...
class C4PathFinder {
 ...
 public:
  ...
  void Clear();
  void Default();
  void Init(bool (*fnPointFree)(int32_t, int32_t),
            C4TransferZones *pTransferZones = NULL);
  BOOL Find(int32_t iFromX, int32_t iFromY, int32_t iToX, int32_t iToY,
            bool (*fnSetWaypoint)(int32_t, int32_t, intptr_t, intptr_t),
 ...
 protected:
  void Run();
  BOOL AddRay(int32_t iFromX, int32_t iFromY, int32_t iToX, int32_t iToY,
              int32_t iDepth, int32_t iDirection, C4PathFinderRay *pFrom,

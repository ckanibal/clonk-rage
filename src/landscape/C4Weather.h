...
class C4Weather {
 ...
 public:
  ...
  int32_t GetSeason();
  int32_t GetClimate();
  BOOL LaunchLightning(int32_t x, int32_t y, int32_t xdir, int32_t xrange,
                       int32_t ydir, int32_t yrange, BOOL fDoGamma);
  BOOL LaunchVolcano(int32_t mat, int32_t x, int32_t y, int32_t size);
  BOOL LaunchEarthquake(int32_t iX, int32_t iY);
  BOOL LaunchCloud(int32_t iX, int32_t iY, int32_t iWidth, int32_t iStrength,

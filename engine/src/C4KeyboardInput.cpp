...
namespace
{
    std::string getKeyName(C4KeyCode k)
    {
		...
		if (result == "world 1") result = "�";
		if (result == "world 2") result = "�";
		if (result == "world 3") result = "�";
		if (result == "world 4") result = "�";
...
const C4KeyCodeMapEntry KeyCodeMap [] = {
	...
	{ VK_OEM_1          , "OEM �"    , "�" }, // German hax
	{ VK_OEM_PLUS       , "OEM +"		, "+" },
	{ VK_OEM_COMMA      , "OEM ,"		, "," },
	{ VK_OEM_MINUS      , "OEM -"		, "-" },
	{ VK_OEM_PERIOD     , "OEM ."		, "." },
	{ VK_OEM_2          , "OEM 2"    , "2" },
	{ VK_OEM_3          , "OEM �"    , "�" }, // German hax
	{ VK_OEM_4          , "OEM 4"    , "4" },
	{ VK_OEM_5          , "OEM 5"    , "5" },
	{ VK_OEM_6          , "OEM 6"    , "6" },
	{ VK_OEM_7          , "OEM �"    , "�" }, // German hax
	{ VK_OEM_8          , "OEM 8"		, "8" },
	{ VK_OEM_AX         , "AX"			, "AX" },

...
bool CStdApp::SetFullScreen(bool fFullScreen, bool fMinimize) { return true; }
...
StdStrBuf CStdApp::Paste(bool fClipboard) { return StdStrBuf(""); }
...
bool CStdDDraw::SaveDefaultGammaRamp(CStdWindow *pWindow) { return true; }
